...
<jsp:include page="fragments/bodyHeader.jsp"/>
    ...
    <form method="get" action="ajax/profile/meals/filter">
        <dl>
        ...
        <button class="btn btn-xs btn-primary edit filter" type="button"><fmt:message key="meals.filter"/></button>
    </form>
...
<jsp:include page="fragments/footer.jsp"/>
   ...
   <div class="form-group">
    ...
    <div class="col-xs-9">
    <input type="number" class="form-control" id="calories" name="calories" placeholder="300">
    </div>
    </div>
