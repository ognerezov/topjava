...
//        .toLocalTime();
        ...
        List<MealWithExceed> filteredMealsWithExceeded = getFilteredWithExceeded(mealList, LocalTime.of(7, 0), LocalTime.of(12, 0), 2000);
    ...
    public static MealWithExceed createWithExceed(Meal um, boolean exceeded) {
        return new MealWithExceed(um.getDateTime(), um.getDescription(), um.getCalories(), exceeded);
    }
}
