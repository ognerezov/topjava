...
import ru.javawebinar.topjava.transferobjects.MealWithExceed;
...
public class MealsUtil {
    ...
    public static final User testUser=new User(null, "Sergey", "ognerezov@yandex.ru",
            "1234", 2000, true, Role.getAdmin());
