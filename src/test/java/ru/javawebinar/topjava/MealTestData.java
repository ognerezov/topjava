...
public class MealTestData {
    ...
    public static final ModelMatcher<MealWithExceed> EXCEED_MATCHER = new ModelMatcher<>(MealWithExceed.class);
    ...
    public static final List<MealWithExceed> MEAL_WITH_EXCEED=MealsUtil.getWithExceeded(MEALS,MealsUtil.DEFAULT_CALORIES_PER_DAY);
    public static final List<MealWithExceed> FILTERED_WITH_EXCEED=MealsUtil.getWithExceeded(Arrays.asList( MEAL3, MEAL2, MEAL1),MealsUtil.DEFAULT_CALORIES_PER_DAY);
    public static final DateTameConstraints CONSTRAINTS= new DateTameConstraints(
            of(2015, Month.MAY, 30,10, 0).toLocalDate(),
            of(2015, Month.MAY, 30,10, 0).toLocalTime(),
            of(2015, Month.MAY, 30,10, 0).toLocalDate(),
            of(2015, Month.MAY, 30,23, 59).toLocalTime());
